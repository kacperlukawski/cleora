...
mod tests {
    ...
    use crate::sparse_matrix_builder::{create_sparse_matrices_builders, SparseMatrixBuilder};
    ...
    fn create_sparse_matrices_if_no_columns_provided() {
        let sparse_matrices = create_sparse_matrices_builders(&[]);
    ...
    fn create_sparse_matrices_if_transient_columns_provided() {
        ...
        let sparse_matrices = create_sparse_matrices_builders(&columns);
        assert_eq!(true, sparse_matrices.is_empty());
        ...
        let sparse_matrices: Vec<SparseMatrix> = create_sparse_matrices_builders(&columns)
            .into_iter()
            .map(|mut b| b.finish())
            .collect();
    ...
    fn create_sparse_matrix_for_undirected_graph() {
        let mut sm =
            SparseMatrixBuilder::new(0u8, String::from("col_0"), 1u8, String::from("col_1"));
